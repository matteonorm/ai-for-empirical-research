---
name: pgp-writing-style
description: Write and edit academic economics papers, working papers, and presentation slides in Paul Goldsmith-Pinkham's style — problem-first framing, clear roadmaps, numbered-and-named assumptions, running examples, and constructive "here's what to do" guidance. Use this skill whenever the user is drafting, revising, or reviewing an econometrics or applied-economics paper, an abstract, an introduction, a referee-style edit, or a research talk, and wants it to match Paul's voice — even if they don't name the style explicitly but ask for an econ paper/intro/slide deck that should read clearly, rigorously, and persuasively.
---
